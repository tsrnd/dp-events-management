...
-- Table Definition ----------------------------------------------
CREATE TABLE IF NOT EXISTS tbl_events_comment (
    id SERIAL PRIMARY KEY,
    user_id integer REFERENCES auth_user(id),
    event_id integer REFERENCES tbl_events(id),
    comment_content text,
    is_delete boolean DEFAULT false,
    root_comment integer
);
-- Indices -------------------------------------------------------
CREATE UNIQUE INDEX IF NOT EXISTS tbl_events_comment_pkey ON tbl_events_comment(id int4_ops);
...
INSERT INTO "auth_user" ("password", "last_login", "is_superuser", "username", "first_name", "last_name", "email", "is_staff", "is_active", "date_joined") VALUES 
    ('pbkdf2_sha256$120000$iSIDgw5GOgZ3$dHIxs2+ZwoAvLgSMm6+GeYK1WuNezAeom/yFb9cEAgE=', NULL, true, 'admin', '', '', '', true, true, '2019-01-15T01:46:39.587628+00:00'::timestamptz);
INSERT INTO "auth_user" ("password", "last_login", "is_superuser", "username", "first_name", "last_name", "email", "is_staff", "is_active", "date_joined") VALUES 
    ('pbkdf2_sha256$120000$iSIDgw5GOgZ3$dHIxs2+ZwoAvLgSMm6+GeYK1WuNezAeom/yFb9cEAgE=', NULL, true, 'tanhle', '', '', '', true, true, '2019-01-14T01:46:39.587628+00:00'::timestamptz);
INSERT INTO "auth_user" ("password", "last_login", "is_superuser", "username", "first_name", "last_name", "email", "is_staff", "is_active", "date_joined") VALUES 
    ('pbkdf2_sha256$120000$iSIDgw5GOgZ3$dHIxs2+ZwoAvLgSMm6+GeYK1WuNezAeom/yFb9cEAgE=', NULL, true, 'yeuem', '', '', '', true, true, '2019-01-13T01:46:39.587628+00:00'::timestamptz);

INSERT INTO "public"."tbl_events"("title", "start_date", "start_time", "end_date", "end_time", "is_daily", "is_all_day", "location", "is_notification", "owner", "event_content", "guest_can_invite", "view_all_guest", "item_preparing", "is_public", "is_cancel", "is_delete", "time_create", "last_edit", "user_edit", "status") VALUES('Year end party', '2019-01-05', '18:00:00', '2019-01-05', '22:00:00', FALSE, FALSE, 'Son Tra - Da Nang', TRUE, 1, 'Please arrange your time to attend our event.', TRUE, TRUE, 'Ice, ice bucket, ice tongs, or scoop', TRUE, FALSE, FALSE, '2019-01-15 01:46:39.587628+00', '2019-01-15 01:46:39.587628+00', 1, 0);
INSERT INTO "public"."tbl_events"("title", "start_date", "start_time", "end_date", "end_time", "is_daily", "is_all_day", "location", "is_notification", "owner", "event_content", "guest_can_invite", "view_all_guest", "item_preparing", "is_public", "is_cancel", "is_delete", "time_create", "last_edit", "user_edit", "status") VALUES('Monday Company Meeting Agenda', '2019-01-15', '08:00:00', '2019-01-15', '09:00:00', FALSE, FALSE, 'Asian Tech', TRUE, 1, 'Please be at the meeting on time. Seeing all you guys there.', TRUE, TRUE, 'Please come to the company before 8:00', TRUE, FALSE, FALSE, '2019-01-15 04:46:39.587628+00', '2019-01-15 05:46:39.587628+00', 1, 1);
INSERT INTO "public"."tbl_events"("title", "start_date", "start_time", "end_date", "end_time", "is_daily", "is_all_day", "location", "is_notification", "owner", "event_content", "guest_can_invite", "view_all_guest", "item_preparing", "is_public", "is_cancel", "is_delete", "time_create", "last_edit", "user_edit", "status") VALUES('Amazing Race ', '2019-01-10', '06:00:00', '2019-01-10', '22:00:00', FALSE, FALSE, 'Hue', TRUE, 1, 'We hope you had as much fun and excitement.', TRUE, TRUE, 'Please come to the company ontime', TRUE, FALSE, FALSE, '2019-01-10 04:46:39.587628+00', '2019-01-10 05:46:39.587628+00', 2, 3);

INSERT INTO "public"."tbl_events_history"("title", "start_date", "start_time", "end_date", "end_time", "is_daily", "is_all_day", "location", 
    "is_notification", "owner", "event_content", "guest_can_invite", "view_all_guest", "item_preparing", "is_cancel", "is_delete", "time_create", "last_edit", 
    "user_edit", "event_id") VALUES('Year end party', '2019-01-06', '18:00:00+00', '2019-01-06', '18:00:00+00', FALSE, FALSE, 'Son Tra - Da Nang', TRUE, 1, 
    'Please arrange your time to attend our event.', TRUE, TRUE, 'Ice, ice bucket, ice tongs, or scoop', FALSE, FALSE, '2019-01-15 01:46:39.587628+00', '2019-01-15 01:46:39.587628+00', 1, 1);
INSERT INTO "public"."tbl_events_history"("title", "start_date", "start_time", "end_date", "end_time", "is_daily", "is_all_day", "location", 
    "is_notification", "owner", "event_content", "guest_can_invite", "view_all_guest", "item_preparing", "is_cancel", "is_delete", "time_create", "last_edit", 
    "user_edit", "event_id") VALUES('Monday Company Meeting Agenda', '2019-01-20', '08:00:00', '2019-01-20', '09:00:00', FALSE, FALSE, 'Asian Tech', TRUE, 1, 
    'Please be at the meeting on time. Seeing all you guys there.', TRUE, TRUE, 'Please come to the company before 8:00', FALSE, FALSE, '2019-01-20 04:46:39.587628+00', '2019-01-20 05:46:39.587628+00', 1, 2);
INSERT INTO "public"."tbl_events_history"("title", "start_date", "start_time", "end_date", "end_time", "is_daily", "is_all_day", "location", 
    "is_notification", "owner", "event_content", "guest_can_invite", "view_all_guest", "item_preparing", "is_cancel", "is_delete", "time_create", "last_edit", 
    "user_edit", "event_id") VALUES('Amazing Race ', '2019-01-12', '06:00:00', '2019-01-12', '22:00:00', FALSE, FALSE, 'Hue', TRUE, 1, 
    'We hope you had as much fun and excitement.', TRUE, TRUE, 'Please come to the company ontime', FALSE, FALSE, '2019-01-12 04:46:39.587628+00', '2019-01-12 05:46:39.587628+00', 2, 3);
...
INSERT INTO "public"."tbl_invite_member"("owner", "user_id", "invite_link", "time_create", "expire_time", "is_confirm", 
    "invite_type", "is_delete") VALUES(1, 1, '/api/group/1/invite', '2019-01-15 01:46:39.587628+00', '2019-01-20 01:46:39.587628+00', TRUE, 1, FALSE); 
INSERT INTO "public"."tbl_invite_member"("owner", "user_id", "invite_link", "time_create", "expire_time", "is_confirm", 
    "invite_type", "is_delete") VALUES(2, 2, '/api/group/2/invite', '2019-01-16 01:46:39.587628+00', '2019-01-21 01:46:39.587628+00', TRUE, 2, FALSE);
INSERT INTO "public"."tbl_invite_member"("owner", "user_id", "time_create", "expire_time", "is_confirm", 
    "invite_type", "is_delete") VALUES(3, 3, '2019-01-17 01:46:39.587628+00', '2019-01-22 01:46:39.587628+00', TRUE, 0, FALSE);
